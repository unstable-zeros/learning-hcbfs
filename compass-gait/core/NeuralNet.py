...
class NeuralNet:
    ...
    def loss_and_constraints(self, params, dataset):
        ...
        total_loss = (
            self.args.lam_safe * safe_loss +
            self.args.lam_unsafe * unsafe_loss +
            self.args.lam_cnt * continuous_loss +
            self.args.lam_dis * discrete_loss +
            self.args.lam_grad * dh_loss +
